...
# wget https://raw.githubusercontent.com/admondtamang/.dotfiles/refs/heads/main/templates/server-deployments/bootstrap.sh; chmod +x bootstrap.sh; ./bootstrap.sh
